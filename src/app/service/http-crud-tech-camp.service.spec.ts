...
describe('HttpCrudTechCampService', () => { 
  let httpCrudTechCampService: HttpCrudTechCampService;
  let httpTestingController: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [HttpCrudTechCampService],
      imports: [HttpClientTestingModule]
    });
    httpTestingController = TestBed.inject(HttpTestingController); 
    httpCrudTechCampService = TestBed.inject(HttpCrudTechCampService); 
  });
  ...
  it('should be created', () => {
    expect(httpCrudTechCampService).toBeTruthy();
  }); 
